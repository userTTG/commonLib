...
public class OptionsPickerBuilder {
    ...
    public OptionsPickerBuilder setTextXOffset(int xoffset_one, int xoffset_two, int xoffset_three,int xoffset_fore) {
        ...
        mPickerOptions.x_offset_fore = xoffset_fore;
        return this;
    }
